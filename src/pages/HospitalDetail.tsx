...
const HospitalDetail = () => {
  ...
  const contactInfo = hospital.contact_info as { phone?: string; email?: string } || {};
  const pricingInfo = hospital.pricing_info as { consultation?: number; surgery_range?: string } || {};
            ...
            <Card>
              <CardContent className="p-6">
                ...
                {hospitalDoctors && hospitalDoctors.length > 0 ? (
                  ...
                  <p className="text-gray-600">No doctors available at this hospital yet.</p>
                )}
              </CardContent>
            </Card>
          </div>
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">${pricingInfo.consultation || 'Contact for pricing'}</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Surgery Range:</span>
                    <span className="font-medium">${pricingInfo.surgery_range || 'Contact for pricing'}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
